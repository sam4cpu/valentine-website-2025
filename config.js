...
const CONFIG = {
    ...
    colors: {
        backgroundStart: "#7B542F",      // Gradient start (try pastel colors for a soft look)
    ...
    music: {
        ...
        musicUrl: "https://res.cloudinary.com/drsb671dw/video/upload/v1770846883/Laufey_-_Valentine_Official_Audio_rjuuau.mp3", // Music streaming URL
